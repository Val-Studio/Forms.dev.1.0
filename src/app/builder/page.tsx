    ...
    <div className="min-h-screen bg-mindflow-cream p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          {/* Left Panel - Question Types or Scales */}
              ...
              <div className="space-y-4">
                {questions.length === 0 ? (
                  <GlassCard className="p-12 text-center">
                    ...
                    <p className="text-mindflow-slate">
                      Виберіть тип питання зліва для початку
                    </p>
                  </GlassCard>
                ) : (
                    ...
                    <GlassCard key={question.id} className="p-6">
                      ...
                      {(question.type === 'single_choice' || question.type === 'multiple_choice') && (
                        <div>
                          ...
                          <Button
                            ...
                            onClick={() => {
                              const newOption = {
                                id: `${question.options?.length || 0 + 1}`,
                                text: '',
                                scoreWeights: {}
                              }
                      ...
                      {question.type === 'likert' && (
                        <div className="mt-4 p-4 bg-white/40 rounded-xl">
                          <p className="text-sm text-mindflow-slate mb-2">
                            Шкала Лайкерта (1-5)
                          </p>
                          <div className="flex gap-2 text-xs">
                            <span>1 - Зовсім не згоден</span>
                            <span className="mx-auto">...</span>
                            <span>5 - Повністю згоден</span>
                          </div>
                        </div>
                      )}
                    </GlassCard>
